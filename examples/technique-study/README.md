...
Render with `node dist/cli.js render examples/technique-study/scene.json -o /tmp/techniques.png`. For the complete API and staged workflow see `docs/atelier.md` and `node dist/cli.js studio-help`.
