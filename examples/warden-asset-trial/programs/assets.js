...
function helmet() {
  // A closed rounded helmet. Dome, narrow eye slit and lower visor read as
  // overlapping shells instead of the previous disconnected angular face plates.
  path(
    'M-21 -9Q-22 -28 -9 -35Q8 -40 18 -28Q23 -20 21 -11L24 -5L24 6Q19 19 5 22L-13 17L-22 6Z',
    grad(-20, -32, 24, 20, [P.light, P.steel, P.dark]),
  );
  path(
    'M-18 -12Q-20 -28 -8 -32Q2 -35 8 -30L10 -12Q-4 -16 -18 -12Z',
    grad(-15, -31, 8, -10, [P.glint, P.light, P.steel]),
    null,
  );
  path('M5 -35L9 -33Q15 -24 15 -13L11 -12Q11 -26 5 -35Z', P.brass, null);
  // The brow follows the dome; a slim horizontal opening supplies the facing.
  path('M-10 -10Q6 -15 21 -10L24 -5L20 -2Q7 -7 -9 -3Z', P.steel);
  path('M-9 -6Q7 -10 21 -6L20 -3Q6 -6 -9 -2Z', P.black, null);
  // Broad lower visor, with one rounded jaw and a continuous rim.
  path('M-8 0Q7 -5 22 -1L23 5Q18 17 5 20L-9 15Z', grad(-8, 0, 23, 19, [P.light, P.steel, P.dark]));
  path('M5 -2L21 0L21 5Q17 14 7 18Q10 7 5 -2Z', P.steel, null);
  path('M-20 -1L-11 1L-11 14L-4 20L-17 15L-23 7Z', P.dark);
  if (detail) {
    line('M-18 -18Q-18 -29 -8 -33', P.glint, 1.1);
    line('M-8 -10Q7 -14 20 -9', P.light, 0.9);
    line('M-7 14Q5 21 17 10', P.light, 0.9);
    for (const [x, y] of [
      [7, 5],
      [12, 4],
      [17, 3],
      ...
      ellipse(x, y, 0.75, 0.9, P.black);
    rivet(-11, -6, 1.8);
  }
  path('M-4 -35Q-19 -50 -37 -37Q-24 -40 -22 -28Q-15 -35 -4 -32Z', P.cloth);
  path('M-6 -35Q-20 -44 -31 -38Q-22 -39 -18 -32Z', P.green, null);
}
function knight() {
